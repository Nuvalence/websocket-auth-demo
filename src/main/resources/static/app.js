...
//     //     url: '/authentication/token',
//     //     headers: {"Authorization": "SuperSecureToken"},
//     //     success: function(result) { webSocketConnect(result) }
//     // })
//
//     // webSocketConnect('test');
//
//     var socket = new SockJS('/websocket-auth-blog-demo');
//     stompClient = Stomp.over(socket);
//     stompClient.connect({}, function (frame) {
//         setConnected(true);
//         console.log('Connected: ' + frame);
...
// function webSocketConnect(authToken) {
//     console.log("Auth Token:" + authToken);
//     var socket = new SockJS('/websocket-auth-blog-demo?authentication=' + authToken);
//     stompClient = Stomp.over(socket);
//     stompClient.connect({}, function (frame) {
//         setConnected(true);
//         console.log('Connected: ' + frame);
